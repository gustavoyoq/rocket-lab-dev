...
export function ProductCard({ product, onEdit, onDelete }: ProductCardProps) {
  ...
  return (
    <article className="group relative overflow-hidden rounded-3xl bg-[#a4ef8e] transition">
      <div className="relative">
        ...
        <div className="absolute right-3 top-3">
          <details className="relative">
            <summary className="cursor-pointer list-none rounded-full bg-white/95 px-3 py-2 text-lg font-bold text-slate-700 transition hover:bg-slate-50">
